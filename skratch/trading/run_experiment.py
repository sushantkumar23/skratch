...
class Runner(object):
    ...
    def _run_one_episode(self):
        ...
        while True:
            ...
            if (step_number == self._steps_per_episode):
    ...
    def _save_summaries(self, iteration,
        ...
        summary = {
            ...
            'average_reward_eval': average_reward_eval
        }
        self._summary_writer.append((summary, iteration))
